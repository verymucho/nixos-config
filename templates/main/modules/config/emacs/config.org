...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Winst"
    user-mail-address "67540662+verymucho@users.noreply.github.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/admin/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/admin/bin" "/profile/bin" "/Users/admin/.npm-packages/bin" "/Users/admin/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
